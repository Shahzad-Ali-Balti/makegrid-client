            ...
            <div className='h-full w-full'>
                ...
                >
                        ...
                        minSize={5} maxSize={100}>
                        {
                            myGenerationsPanelSize > 17 ? (
                                ...
                                <div
                                    ...
                                    <p className="text-xs font-medium text-muted-foreground">Please
                                        expand to see more</p>
                                </div>
                            )
                        }
                    </ResizablePanel>
                    <ResizableHandle className='hover:bg-primary hover:w-[2px]'
                                     withHandle/>
                    <ResizablePanel
                    ...
                    <ResizablePanel
                        ...
                        defaultSize={PROMPT_PANEL_DEFAULT_SIZE} maxSize={50}
                        minSize={0}>
                        {
                            promptPanelSize > 10 ? (
                                <PromptPanel/>
                ...
                <Card>
                    <CardHeader className="p-4 pb-2">
                        <div className="flex gap-2 items-center">
                            <BoxIcon className="stroke-gray-500" height={20}
                                     width={20}/>
                            New Model
                        </div>
                    </CardHeader>
                    ...
                    <CardContent className="p-4 pt-2">
                        <Tabs defaultValue="text" className="w-full">
                            <TabsList className="flex">
                                <TabsTrigger className="flex flex-grow"
                                             value="text">Text
                                    to 3D</TabsTrigger>
                                <TabsTrigger className="flex flex-grow"
                                             value="image">Image
...
const ModelPreviewPanel = ({panelSize}: { panelSize: number }) => {
            ...
            <div className="flex flex-wrap justify-between px-4 py-2">
                <div className="flex gap-2">
                    ...
                    <ToggleGroup type="single">
                        ...
                        <ToggleGroupItem title="Animations" value="animations"
                                         aria-label="Toggle italic">
                            <WandSparklesIcon/>
                        </ToggleGroupItem>
                    </ToggleGroup>
...
const MyGenerationSection = ({panelSize}: { panelSize: number }) => {
    return (
        <div className="w-full flex flex-col gap-2">
            ...
            <div
                className={cn("grid gap-2", panelSize > 50 ? "grid-cols-6" : panelSize > 36 ? "grid-cols-3" : panelSize > 22 ? "grid-cols-2" : "grid-cols-1")}>
                <MyGenerationCard/>
                <MyGenerationCard/>
                <MyGenerationCard/>
            </div>
